        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage community page content and programs</p>
            </div>
            <button
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="connect">Connect With Us</option>
                  </select>
                </div>
                <div>
                    ...
                    <div className="flex-1">
                      ...
                      {item.button_text && (
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          {item.button_url && (
                            <a href={item.button_url} target="_blank" rel="noopener noreferrer" className="text-lime-600 hover:text-lime-800">
                              ({item.button_url})
                            </a>
                          )}
                        </div>
